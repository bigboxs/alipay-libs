...
export default class Alipay {
  ...
  // 默认
  public createOrder(apiParams: AlipayTradePrecreateArgs, publicParams?: AlipayPublicArgs) {
    return this.tradePrecreate(apiParams, publicParams)
  }

  // 当面付
  public createNativeOrderURL(apiParams: AlipayTradePrecreateArgs, publicParams?: AlipayPublicArgs) {
    return this.tradePrecreate(apiParams, publicParams)
  }
  ...
  // APP
  public createAppOrderURL(apiParams: AlipayCreateOrderArgs, publicParams?: AlipayPublicArgs): ApiResponse {
